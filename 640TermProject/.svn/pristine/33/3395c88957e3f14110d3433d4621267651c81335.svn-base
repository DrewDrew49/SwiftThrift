...
if(empty($_SESSION['logged_in'])){
	...
	<ul class="nav nav-tabs" id="tabs">
  		...
  		<button type="submit" class="btn btn-default pull-right" id="refresh"><i class="glyphicon glyphicon-refresh"></i> Refresh</button>	
	</ul>
	<!-- begin posts tab -->
    <div class="tab-content">
      <div class="tab-pane active" id="posts">
		...
		foreach($allItems as $item){
			...
			$cat = CategoryHandler::getCategoryWithId((int)$item['category']);
