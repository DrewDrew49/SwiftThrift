...
} elseif (basename($_SERVER["SCRIPT_NAME"]) == 'category.php' && !empty($_GET['id'])){
	// If we are on the category page and a category id is specificed
...
<div id="search-bar">
	<form method="post" action="results.php">
		<div class="input-group">
			...
			<input type="hidden" name="categoryID" value="<?php echo (empty($selectedCategory) == true ? "all" : $selectedCategory) ?>">
			<!-- Query input -->
